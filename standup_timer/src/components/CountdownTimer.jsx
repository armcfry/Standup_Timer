...
function CountdownTimer(props) {
  ...
  const play = require('../assets/play_button.png');
  const pause = require('../assets/pause_lines.png');
  const [img, setBtnImg] = useState(false);
  ...
  return (
    <div className="w3-container" style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div className="w3-container" style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
        <button className="pause_img" type="pauseButton" onClick={pauseTimer}><img src={!img ? pause : play} /></button>
